<?php
    ...
    $conditioners = mysqli_query($link,"SELECT * FROM `products` WHERE cat_id=2 ");
?>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-link" href="">Conditioners</a>
...
<div class="d-flex justify-content-center align-items-center mt-5"> 
  <button type="button" class="btn custom-btn" id="btn-all-conditioners">ALL</button>
  <button type="button" class="btn custom-btn" id="btn-leave-in">LEAVE-IN</button>
  <button type="button" class="btn custom-btn" id="btn-deep-conditioners">DEEP CONDITIONERS</button>
</div> 

<section class="py-5">
  <div class="container px-4 px-lg-5 mt-5">
    <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center" id="conditioner-card-container">
...
<script>
    ...
    const conditionerCards = Array.from(document.querySelectorAll("#conditioner-card-container .col"));
    ...
    document.getElementById("btn-all-conditioners").addEventListener("click", () => {
      filterCards("all");
    });

    document.getElementById("btn-leave-in").addEventListener("click", () => {
      filterCards("leave-in");
    });

    document.getElementById("btn-deep-conditioners").addEventListener("click", () => {
      filterCards("deep-conditioners");
    });
  });
</script>
</body>
